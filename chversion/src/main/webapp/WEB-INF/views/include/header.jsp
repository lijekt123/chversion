...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link href="<%=context %>/resources/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
    <link href="<%=context %>/resources/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
