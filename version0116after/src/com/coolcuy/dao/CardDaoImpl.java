...
public class CardDaoImpl implements CardDao {
	...
	public int add(CardDto object, Connection conn) throws SQLException {
		...
		String quary = "INSERT INTO CARD VALUES(?,?,TO_DATE(?, 'YYYY-MM-DD'),?,?,SYSDATE,?)";
	...
	public int delete(String element, Connection conn) throws SQLException {
		PreparedStatement pstmt = null;
		String quary = "DELETE FROM CARD WHERE CARDNUMBER =?";
	...
	public int update(CardDto object, Connection conn) throws SQLException {
		PreparedStatement pstmt = null;
		String quary = "UPDATE CARD SET CARDPASSWORD=? "
				+ "WHERE CARDNUMBER=?";
	...
	public CardDto get(String element, Connection conn) throws SQLException{
		...
		String quary = "SELECT CARDNUMBER, CARDTYPE, "
				+ "TO_CHAR(CARDEXPIRYDATE, 'YYYY-MM-DD') AS CARDEXPIRYDATE, "
	...
	public int checkDuplicate(String cardNumber, Connection conn) throws SQLException{
		...
		String quary ="SELECT COUNT(CARDNUMBER) AS COUNT FROM CARD WHERE CARDNUMBER=?";
	...
	public int getCount(Connection conn) throws SQLException {
		...
		String quary = "SELECT COUNT(CARDNUMBER) FROM CARD";
	...
	public int checkPassword(String cardNumber, String password, Connection conn) throws SQLException{
		...
		String quary = "SELECT COUNT(CARDNUMBER) AS COUNT FROM CARD WHERE CARDNUMBER=? AND CARDPASSWORD=?";
		int x = -1;
