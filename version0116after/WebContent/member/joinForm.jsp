...
function checkStep1(objpass,objpassOk,id1,id2,id3,id4,id5,id6){
	if(frm.name.value == ""){
		alert("이름이 비었따");
...
function licenseAdd(x, y) {
    if (y.length == x.maxLength) {
        var next = x.tabIndex;
        next++;
        document.getElementById("licenseNum"+next).focus();
    }
}
        ...
        <section id="row4">
            ...
            <div id="row4_02">
                ...
                <div id="row4_02_check">
                    <input type="checkbox" name="primaryArea" value="서울/인천"><span>서울/인천</span>
            ...
            <div id="next_bt">
                <a href="#" class="previous_bt" onclick="changeDisplay('row4','top_row2','row2_11','row2_01','row2_012','row2_011');">이전단계</a>
            </div>
            <div>
                <a href="#" class="next_bt" onclick="checkStep1('firpass','secpass','row4','row5','row2_11','row2_21','row2_012','row2_013');">다음단계</a>
            </div>
        </section>
      ...
      <!--  -------------------------------회원정보---------------------------------->
        ...
        <section id="row5">
                ...
                <div class="row5_02_td">면허번호</div>
                 <div class="row5_02_back">
                    <div class="row5_02_num01">
                    	<input id="licenseNum1" type="text" size="2" tabindex="1" maxlength="2"
                    		   name="licenseNumber1" 
                               onkeyup="licenseAdd(this, this.value)"
                               onkeydown="return showKeyCode(event)">
                    </div>
                    <div class="row5_02_num02">
                    	<input id="licenseNum2" type="text" size="2" tabindex="2" maxlength="2"
                    		   name="licenseNumber2" 
                    		   onkeyup="licenseAdd(this, this.value)"
                    		   onkeydown="return showKeyCode(event)">
                    </div>
                    <div class="row5_02_num03">
                    	<input id="licenseNum3" type="text" size="6" tabindex="3" maxlength="6"
                    		   name="licenseNumber3" 
                    	 	   onkeyup="licenseAdd(this, this.value)"
                    	 	   onkeydown="return showKeyCode(event)">
                    </div>
                    <div class="row5_02_num04">
                    	<input id="licenseNum4" type="text" size="2" tabindex="4" maxlength="2"
                    		   name="licenseNumber4" 	
                    		   onkeyup="licenseAdd(this, this.value)"
                    		   onkeydown="return showKeyCode(event)">
                    </div>
            ...
            <div id="row5_04">
                ...
                <div class="row5_02_back">
                    <div id="row5_04_num01">
                  		<input type="text" name="cardNumber1" tabindex="1" maxlength="4"
                  			   id="CardNum1"
                  			   onkeyup="cardAdd(this, this.value)"
                   		       onkeydown="return showKeyCode(event)">
                    </div>
                    <span class="num_sl">-</span>
                    <div id="row5_04_num02">
                    	<input type="text" name="cardNumber2" tabindex="2" maxlength="4"
                    		   id="CardNum2"
                  			   onkeyup="cardAdd(this, this.value)"	
                    		   onkeydown="return showKeyCode(event)">
                    </div>
                    <div class="num_sl_01">-</div>
                    <div id="row5_04_num03">
                    	<input type="text" name="cardNumber3" tabindex="3" maxlength="4"
                    		   id="CardNum3"
                  			   onkeyup="cardAdd(this, this.value)"
                    		   onkeydown="return showKeyCode(event)">
                    </div>
                    <div id="num_sl_02">-</div>
                    <div id="row5_04_num04">
                    	<input type="text" name="cardNumber4" tabindex="4" maxlength="4"
                    		   id="CardNum4"
                  			   onkeyup="cardAdd(this, this.value)"
                    		   onkeydown="return showKeyCode(event)">
                    </div>
                ...
                <div class="row5_02_td">생년월일</div>
                <div class="row5_02_back">
                    <div class="row5_02_birth"><input type="text" name="cardBirth" maxlength="6"></div>
                    <div id="birth_text">(6자리)</div>
                </div>
            ...
            <div>
                ...
                onclick="checkStep2('row5','row6','row2_21','row2_31','row2_013','row2_014'), joinSubmit();">회원가입</a>
            </div>
        </section>
	</form>
        <!-----------------------------------등록----------------------------------->
