...
<body>
  <div id="wrap">
        <header id="header">
            ...
            <div id="top_back">
                <div id="small_nav">
                    <a href="../list.do">로그인</a><span>|</span>
                    <a href="member/joinForm.do">회원가입</a><span>|</span>
                    <a href="#">마이페이지</a>
                </div>
            </div>
        ...
        <section id="row2">
            <div class="circle" id="circle1">
                <div id="circle1_icon"><a href="#" class="over"><img src="imag/icon_1.png"><img src="../imag/icon_1_over.png" class="imgover"></a></div>
                <div id="circle1_text"><a href="#">이용방법</a></div>
            </div>
            <div class="circle" id="circle2">
                <div id="circle2_icon"><a href="#"><img src="imag/icon_2.png"></a></div>
                <div id="circle2_text"><a href="#">법인혜택</a></div>
            </div>
            <div class="circle" id="circle3">
                <div id="circle3_icon"><a href="#"><img src="imag/icon_3.png"></a></div>
                <div id="circle3_text"><a href="#">이벤트</a></div>
            </div>
            <div class="circle" id="circle4">
                <div id="circle4_icon"><a href="#"><img src="imag/icon_5.png"></a></div>
                <div id="circle4_text"><a href="#">쿠폰</a></div>
            </div>
            <div class="circle" id="circle5">
                <div id="circle5_icon"><a href="#"><img src="imag/icon_4.png"></a></div>
        ...
        <section id="row3">
            ...
            <div id="row3_03">
                ...
                <div>
                    <a href="#" id="row3_03_img"><img src="imag/row3_03_icon01.png"></a>
                </div>
            </div>
            <div id="row3_04">
                <div>
                    <a href="#">
                        <img src="imag/row3_04_img02.png">
                    </a>
                </div>
            </div>
            <div class="clear"></div>
